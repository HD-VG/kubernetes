...
//este sera el caso de uso para ver los Materials de la api 
...
@Injectable()
export class GetApiMaterialUseCase {
    constructor(
    ...
    async execute() {
        return this.configurationTypeMaterialRepository.findAllDataApi();
    }
}
