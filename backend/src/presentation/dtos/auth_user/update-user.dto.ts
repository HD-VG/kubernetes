...
export class RolToRemove {
  @ApiProperty({
    ...
    description: 'UUID de la asignación User-Rol que se debe eliminar.',
  })
  @IsUUID('4', { message: 'El campo id_user_rol debe ser un UUID válido.' })
  @IsString({ message: 'El campo id_user_rol debe ser un string.' })
...
export class RolToAdd {
  @ApiProperty({
    example: 'a1b2c3d4-e5f6-7890-1234-567890abcdef',
    description: 'UUID de rol que se agregara al usuario!.',
  })
