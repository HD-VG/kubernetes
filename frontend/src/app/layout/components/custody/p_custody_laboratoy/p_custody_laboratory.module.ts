...
import { PCustodyLaboratoryRoutingModule } from './p_custody_laboratory-routing.module';
...
@NgModule({
    declarations: [
        PCustodyLaboratoryComponent
    ],
    imports: [
        CommonModule,
        PCustodyLaboratoryRoutingModule,
        TableModule,
        FileUploadModule,
        FormsModule,
        ButtonModule,
...
export class CustodyLaboratoryModule { }
