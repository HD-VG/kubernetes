...
import { ConfigurationTypeMachineRoutingModule } from './a-confTypeMachine-routing.module';
...
@NgModule({
    declarations: [
        ConfigurationTypeMachineComponent
    ],
    imports: [
        CommonModule,
        ConfigurationTypeMachineRoutingModule,
        TableModule,
        FormsModule,
        ReactiveFormsModule,
        ButtonModule,
    ...
    providers: [ConfigurationTypeMachineService, AuthService, CommonService],
